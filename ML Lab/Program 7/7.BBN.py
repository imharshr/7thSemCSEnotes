...
#print(bp.nodes.MultiMixture([ageEnum['Youth'], genderEnum['Female'], familyHistoryEnum['No'], dietEnum['Low'], lifeStyleEnum['Athlete'], cholesterolEnum['Normal']], bp.nodes.Categorical, p_heartdisease).get_moments()[0][heartDiseaseEnum['No']])
